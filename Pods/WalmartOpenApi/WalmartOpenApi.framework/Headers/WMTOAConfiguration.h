...
/** The `WMTOAConfiguration` class manages the configurations for the sdk.
 *
...
@class WMTOAApiClient;

@interface WMTOAConfiguration : NSObject

/**
 * Default api logger
 */
@property (nonatomic, strong) WMTOALogger * logger;

/**
 * Default api client
 */
@property (nonatomic) WMTOAApiClient *apiClient;
