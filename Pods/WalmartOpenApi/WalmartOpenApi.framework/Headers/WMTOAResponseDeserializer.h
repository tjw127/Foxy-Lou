 ...
 */
extern NSString *const WMTOADeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const WMTOATypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const WMTOAEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const WMTOAUnknownResponseObjectErrorCode;

@protocol WMTOAResponseDeserializer <NSObject>
...
@interface WMTOAResponseDeserializer : NSObject <WMTOAResponseDeserializer>
